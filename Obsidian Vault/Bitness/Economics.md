The economy for most hackers is in the realm of DAOs and digital assets, mostly crypto, because economic theory is a tool to implement strategies for the user and not for the centralized nation-state.
